...
import { PairItem, PairItemsArray, PairProduct, ProductItemsProps, ProductList } from '@/types';
...
const PairProductItems: React.FC<PairItemsArray> = ({ list, queryString, prodLoading }) => {
