...
const CartDrawer = ({ handleMenuIcon }: { handleMenuIcon: () => void }) => {
  ...
  const t: any = useScopedI18n("carDrawer");
    ...
    <>
      ...
      {isOpen && (
        ...
        >
          ...
          <Link
            href={"/cart"}
            className="block my-2 border border-white rounded-lg text-center px-4 py-2 mx-auto hover:bg-orange-400 hover:border-orange-400"
          >
            {t("OpenCart")}
          </Link>
            ...
            <div>
              {!cartLoading ? (
                              ...
                              <tr className="cursor-pointer bg-white border-b rounded-lg hover:bg-gray-100">
                                ...
                                <td className="px-6 py-4">
                                  <Link
                                    ...
                                    href={`/product/${product?.id}`}
                                  >
                                    {`${product?.brand_name} ${product?.tread_name} ${product?.size_text}`.substring(
                                      0,
                                      30
                                    ) + `...`}
                                  </Link>
                                ...
                                <td className="px-6 py-4 text-white">
                                  <div
                                    onClick={(e) =>
                                      removeProductsFromCartCalled(product?.id)
                                    }
                ...
                <div
                  ...
                  className="z-20 sm:w-max w-sm max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow absolute w-full md:right-0 lg:right-auto"
                ...
                >
                  <div className="flex justify-center items-center bg-slate-50 text-green-800 w-fit mx-auto px-4 py-2 rounded-lg">
                    ...
                    <div className="text-xl animate-pulse font-bold mx-2">
                      Loading...
                    </div>
                  </div>
                </div>
