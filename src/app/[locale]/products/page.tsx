...
const Products = () => {
    ...
    return (
        <div>
            ...
            <div className="my-8">
                <h1 className="text-start sm:text-center text-5xl text-mono font-bold decoration-orange-400 underline sm:mx-0 mx-8">
                    {products ? products.length : 0} {t("ProductsFound")}</h1>
                <BreadCrumb
                links={[
                    {name:"Home", link:"/"},
                    {name:"Products", link:"/"},
